...
enum ProstateCancerDetails: String, Codable, CaseIterable, TitleConvertible {
    case morethan1
    case under65
    case over65
...
enum StomachCancerDetails: String, Codable, CaseIterable, TitleConvertible {
    case morethan3
    case under40
    case under50
    case complex
    ...
    var title: String {
        ...
        case .nothing: return "Ничего из перечисленного"
        }
    }
}

enum ColonCancerDetails: String, Codable, CaseIterable, TitleConvertible{
    case lessthan60
    case over60
    case manyRelatives
    case manyCousins
